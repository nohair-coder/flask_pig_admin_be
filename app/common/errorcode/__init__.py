...
error_code = {
    ...
    '1000_8003': '1000_8003: 获取系统某个配置失败',
    ...
    '1005_0004': '1005_0004: 日增重和饲料转化率数据处理失败',

    # `app/admin/controller/pig_abnormal_analyse
    '1006_0001': '1006_0001: 预警分析数据获取失败',
